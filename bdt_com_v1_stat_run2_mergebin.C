...
void bdt_com_v1_stat_run2_mergebin(){
...
//  pad1->cd();
  ...
  TFile *fdata1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/Data/BDT_UL18_MC_hists_data_wt1.root");
  TH1F  *h1 = (TH1F*)fdata1->Get("BDT_UL18_MC_test_sig_mvaHist");
  h1->Rebin(2);
  ...
  TFile *f1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/TTGJets/BDT_UL18_MC_hists_TTGJets_wt1.root");
  TH1F *hmc1 = (TH1F*)f1->Get("BDT_UL18_MC_test_sig_mvaHist");
  hmc1->Rebin(2);
  ...
  TFile *f2 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/TTSL/BDT_UL18_MC_hists_TTSL_wt1.root");
  TH1F *hmc2 = (TH1F*)f2->Get("BDT_UL18_MC_test_sig_mvaHist");
  hmc2->Rebin(2);
  ...
  TFile *f3 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/TT2L2Nu/BDT_UL18_MC_hists_TT2L2Nu_wt1.root");
  TH1F *hmc3 = (TH1F*)f3->Get("BDT_UL18_MC_test_sig_mvaHist");
  hmc3->Rebin(2);
  ...
  TFile *f4 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/DY/BDT_UL18_MC_hists_DY_wt1.root");
  TH1F *hmc4 = (TH1F*)f4->Get("BDT_UL18_MC_test_sig_mvaHist");
  hmc4->Rebin(2);
  ...
  TFile *f5 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/WH20/BDT_UL18_MC_hists_20_wt1.root");
  TH1F *hsig1 = (TH1F*)f5->Get("BDT_UL18_MC_test_sig_mvaHist");
  hsig1->Rebin(2);

  TFile *f6 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/full_runII/WH55/BDT_UL18_MC_hists_55_wt1.root");
...
hdata1->Draw("pz same");
  ...
  TLatex *t_lumi = new TLatex(0.9, 0.92, "137 fb^{-1} (13 TeV)");
  t_lumi->SetNDC();
...
leg_ratio->Draw();
    ...
    c1->SaveAs("bdt_com_stat_pas_run2_mergebin.png");
    c1->SaveAs("bdt_com_stat_pas_run2_mergebin.pdf");
