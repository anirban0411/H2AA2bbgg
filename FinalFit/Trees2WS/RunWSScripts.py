...
#  parser.add_option('--targetMasses', dest='targetMasses', default='120,130', help="Comma separated list of target masses")
  parser.add_option('--inputMass', dest='inputMass', default='20', help="Input mass of workspace")
  parser.add_option('--targetMasses', dest='targetMasses', default='15,25', help="Comma separated list of target masses")
