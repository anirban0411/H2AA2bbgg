...
parser.add_option("--inputMass", dest="inputMass", default=20, type='int', help="Input mass")
...
parser.add_option("--xvar", dest="xvar", default="CMS_hgg_mass:15:70", help="Input mass variable (name:xmin:xmax)")
parser.add_option("--targetMass", dest="targetMass", default=25, type='int', help="Target mass")
