...
#  parser.add_option("--cat", dest='cat', default='RECO_0J_PTH_0_10_Tag0', help="RECO category to package")
  parser.add_option("--cat", dest='cat', default='auto', help="RECO category to package")
...
#  parser.add_option("--massPoints", dest='massPoints', default='120,125,130', help="Comma separated list of mass points")
  parser.add_option("--massPoints", dest='massPoints', default='20,25,30,35,40,45,50,55,60', help="Comma separated list of mass points")
...
for mp in opt.massPoints.split(","): 
  print fNames,opt.exts,mp,opt.cat
