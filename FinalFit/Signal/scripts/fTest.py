...
#  parser.add_option('--mass', dest='mass', default='125', help="Mass point to fit")
  parser.add_option('--mass', dest='mass', default='20', help="Mass point to fit")
  parser.add_option('--doPlots', dest='doPlots', default=False, action="store_true", help="Produce Signal fTest plots")
#  parser.add_option('--nBins', dest='nBins', default=10, type='int', help="Number of bins for fit")
  parser.add_option('--nBins', dest='nBins', default=55, type='int', help="Number of bins for fit")
  parser.add_option('--threshold', dest='threshold', default=0, type='int', help="Threshold number of events")
...
for pidx, proc in enumerate(procsToFTest): 
  ...
  print(opt.mass)
  print(opt.nBins)
  print(datasets_RV[opt.mass].numEntries() )
  if datasets_RV[opt.mass].numEntries() < opt.threshold: continue  
  else:
    print("code running fine")
    ssfs = od()
