...
#    self.physOpt = ["higgsMassRange=90,250"]
    self.physOpt = ["higgsMassRange=15,70"]
    self.bin = True
    ...
    self.verbose = 0
#    self.mass = 125
    self.mass = 20,25,30,35,40,45,50,55,60
...
#    mh = np.linspace(120.,130.,101)
    mh = np.linspace(20.,60.,101)
    # XS
    print self.xsbrMap[self.proc]
  ...
  def buildEffAccSpline(self):
	...
	print "M , xs , br , sumw , eff = ",mp,xs,br, sumw,ea[-1]
