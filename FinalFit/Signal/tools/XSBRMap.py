...
#globalXSBRMap['example']['decay'] = {'mode':'constant','factor':0.01}
#globalXSBRMap['example']['ggh_GG2H'] = {'mode':'constant','factor':1.47}

globalXSBRMap['example']['decay'] = {'mode':'constant','factor':0.001}
globalXSBRMap['example']['ggh_GG2H'] = {'mode':'constant','factor':0.9}

#globalXSBRMap['example']['ggh_GG2H'] = {'mode':'WH','factor':BR_W_lnu}
#globalXSBRMap['example']['ggh_GG2H'] = {'mode':'WH','factor':0.05*BR_W_lnu}
...
#globalXSBRMap['STXS']['ggh_GG2H'] = {'mode':'ggH','factor':0.0809}
