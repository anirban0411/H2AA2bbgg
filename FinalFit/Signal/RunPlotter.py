...
def get_options():
  ...
  parser.add_option('--cats', dest='cats', default='H2AA2bbgg_Tag0', help="Comma separated list of analysis categories to include. all = sum of all categories, wall = weighted sum of categories (requires S/S+B from ./Plots/getCatInfo.py)")
...
#  parser.add_option("--MH", dest="MH", default='125', help="Higgs mass (for pdf)")
  parser.add_option("--mass", dest="mass", default='60', help="Mass of datasets")
  parser.add_option("--MH", dest="MH", default='60', help="Higgs mass (for pdf)")
  parser.add_option("--nBins", dest="nBins", default=145, type='int', help="Number of bins")
