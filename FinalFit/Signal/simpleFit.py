...
def get_options():
  ...
  parser.add_option('--nGauss', dest='nGauss', default=5, type='int', help="Number of gaussians")
...
MHHigh = '60'
massPoints = '25'
nBins = 500 #nBins for fit
MHPolyOrder = 1 # dependence of fit params on MH, set to 0 if using one mass point
minimizerMethod = 'TNC'
...
datasets['25'] = ws.data("%s_25_13TeV_%s"%(pm,opt.cat))
