...
def loadSignal(inputVars):
  ...
  dataset_Sig = uproot.open("2018/WH60/WH_mA60_vf_weight_nom.root")['tree'].arrays(inputVars,library='pd')
...
def loadMCBackground(inputVars, inputVarsMC):
  ...
  dataset_Bkg = uproot.open('full_runII/bkg_nom/Allbkg_bdt_v1_weight_nom.root')['tree'].arrays(inputVars,library='pd')
  df_bkg = dataset_Bkg
