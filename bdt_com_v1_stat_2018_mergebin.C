...
void bdt_com_v1_stat_2018_mergebin(){
...
//  pad1->cd();
  ...
  TFile *fdata1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/Data/BDT_UL18_MC_hists.root");
  ...
  TFile *f1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/TTGJets/BDT_UL18_MC_hists.root");
  ...
  TFile *f2 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/TTSL/BDT_UL18_MC_hists.root");
  ...
  TFile *f3 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/TT2L2Nu/BDT_UL18_MC_hists.root");
  ...
  TFile *f4 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/DY/BDT_UL18_MC_hists.root");
  ...
  TFile *f5 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/WH20/BDT_UL18_MC_hists.root");
  TH1F *hsig1 = (TH1F*)f5->Get("BDT_UL18_MC_test_sig_mvaHist");
  hsig1->Rebin(2);

  TFile *f6 = TFile::Open("/home/anirban/data/hh/workspace/analysis/BDT/param_bdt/param_training/2018/WH55/BDT_UL18_MC_hists.root");
...
hdata1->Draw("pz same");
  ...
  TLatex *t_lumi = new TLatex(0.9, 0.92, "59.7 fb^{-1} (13 TeV)");
  t_lumi->SetNDC();
...
leg_ratio->Draw();
    ...
    c1->SaveAs("bdt_com_stat_pas_2018_mergebin.png");
    c1->SaveAs("bdt_com_stat_pas_2018_mergebin.pdf");
