...
//  pad1->SetGridy();
  ...
  TH1F  *h1 = (TH1F*)fdata5->Get("h_chi2");
  h1->Rebin(4);
  ...
  TH1F  *h2 = (TH1F*)fdata6->Get("h_chi2");
  h2->Rebin(4);
  h1->Add(h2);
  ...
  TH1F *hsig1 = (TH1F*)f17->Get("h_chi2");
  hsig1->Scale(w17);
  ...
  TH1F *hsig31 = (TH1F*)f33->Get("h_chi2");
  hsig31->Scale(w33);
...
t2b->DrawLatex(0.9, 0.92, "41.5 fb^{-1} (13 TeV)");
