...
void H2AA2bbgg_analysis_treeread_data_mc_2()
{
    TFile *f = new TFile("WH_mA20_v6.root");
    TTree *Tout = (TTree*)f->Get("Tout");
    TFile *fout = new TFile("WH_mA20_v6_isEleMu.root","RECREATE");
    

    TH1F* h_leppt = new TH1F("h_leppt", "h_leppt", 60, 0.0, 600.0);
    h_leppt->Sumw2();

    TH1F* h_lepeta = new TH1F("h_lepeta", "h_lepeta", 30, -3.0, 3.0);
    h_lepeta->Sumw2();

    TH1F* h_b1pt = new TH1F("h_b1pt", "h_b1pt", 60, 0.0, 600.0);
    h_b1pt->Sumw2();

    TH1F* h_b1eta = new TH1F("h_b1eta", "h_b1eta", 30, -3.0, 3.0);
    h_b1eta->Sumw2();

    TH1F* h_b2pt = new TH1F("h_b2pt", "h_b2pt", 60, 0.0, 600.0);
    h_b2pt->Sumw2();

    TH1F* h_b2eta = new TH1F("h_b2eta", "h_b2eta", 30, -3.0, 3.0);
    h_b2eta->Sumw2();

    TH1F* h_pho1pt = new TH1F("h_pho1pt", "h_pho1pt", 60, 0.0, 600.0);
    h_pho1pt->Sumw2();

    TH1F* h_pho1eta = new TH1F("h_pho1eta", "h_pho1eta", 30, -3.0, 3.0);
    h_pho1eta->Sumw2();

    TH1F* h_pho2pt = new TH1F("h_pho2pt", "h_pho2pt", 60, 0.0, 600.0);
    h_pho2pt->Sumw2();
    ...
    TH1F* h_invmassbbgg = new TH1F("h_invmassbbgg", "h_invmassbbgg", 200, 0.0, 400.0);
    h_invmassbbgg->Sumw2();
   
    TH1F* h_bb_inv_mass = new TH1F("h_bb_inv_mass", "h_bb_inv_mass", 100, 0.0, 200.0);
    h_bb_inv_mass->Sumw2();

    TH1F* h_bb_inv_mass_corr = new TH1F("h_bb_inv_mass_corr", "h_bb_inv_mass_corr", 100, 0.0, 200.0);
