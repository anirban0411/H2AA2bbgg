...
void BDTFileMaker_v2016_vCorr()
{
	...
	double TTGJets = (36000*4.078)/(13568560.0);
        double DY = (36000*5343)/(156230700.0);
        double TTSL = (36000*365.34)/(82523700000.0);
        double TT2L2Nu = (36000*88.29)/(3852160000.0);
	double WH_mA20 = (36000*0.01)/(811375);
        double WH_mA25 = (36000*0.01)/(691463);
        double WH_mA30 = (36000*0.01)/(559039);
        double WH_mA35 = (36000*0.01)/(857614);
        double WH_mA40 = (36000*0.01)/(707937);
        double WH_mA45 = (36000*0.01)/(778452);
        double WH_mA50 = (36000*0.01)/(839943);
        double WH_mA55 = (36000*0.01)/(788199);
        double WH_mA60 = (36000*0.01)/(671806);
	...
	TFile *f = new TFile("/home/abala/local_bkp/analysis/root_file/WH_2016_merg/WH_mA60_v2.root");
        TTree *tr = (TTree*)f->Get("Tout");

	TFile *fout = new TFile("/home/abala/local_bkp/analysis/BDT/2016_merg/WH60/WH_mA60_vf_weight_nom.root","RECREATE");
