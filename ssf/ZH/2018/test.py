...
files = [f'output_ZHToAA2B2G_M{mass}_pythia8_ggh.root' for mass in range(20, 65, 5)]
...
for file, mass in zip(files, mass_points):
    ...
    with uproot.open(file) as f:
        tree_name = f"ggh_{mass}_13TeV_H2AA2bbgg_Tag0"  # Adjust with the format of your tree name
        tree = f[tree_name]
    ...
    hist, bin_edges = np.histogram(x_data, bins=550, range=(15, 70), weights=weights*59.73)
