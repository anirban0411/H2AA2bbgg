...
void BDTFileMaker_v2017_vCorr()
{
	...
	double TTGJets = (41500*4.078)/(1.60904e+07);
        double DY = (41500*5343)/(6.18062e+07);
        double TTSL = (41500*365.34)/(1.00204e+11);
        double TT2L2Nu = (41500*88.29)/(7.49227e+09);
	double WH_mA20 = (41500*0.01)/(740850);
        double WH_mA25 = (41500*0.01)/(959601);
        double WH_mA30 = (41500*0.01)/(512225);
        double WH_mA35 = (41500*0.01)/(953567);
        double WH_mA40 = (41500*0.01)/(712887);
        double WH_mA45 = (41500*0.01)/(698864);
        double WH_mA50 = (41500*0.01)/(995462);
        double WH_mA55 = (41500*0.01)/(674995);
        double WH_mA60 = (41500*0.01)/(725922);
	...
	TFile *f = new TFile("/home/abala/local_bkp/analysis/root_file/WH_2017/full_reg/v1/WH_mA60_v1.root");
        TTree *tr = (TTree*)f->Get("Tout");

	TFile *fout = new TFile("2017/WH60/WH_mA60_vf_weight_nom.root","RECREATE");
