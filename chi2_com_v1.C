...
//  pad1->SetGridy();
  ...
  double w5 = (lumi_16*0.01*20)/(486982);
  ...
  double w31 = (lumi_16*0.01*20)/(286518);
...
//  hsig2->Draw("hist same");
  ...
  hs->GetYaxis()->SetTitle("Events / 0.5");
...
leg_ratio->Draw();
  ...
  c1->SaveAs("chi2_com_v1_paper.png");
  c1->SaveAs("chi2_com_v1_paper.pdf");
}
