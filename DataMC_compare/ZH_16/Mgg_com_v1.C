...
//  c1->SetLogy();
  ...
  TFile *fdata3 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/ZH_2016APV/full_reg/V1/DoubleEG_2016PreAPVv2_isEleMu.root");
