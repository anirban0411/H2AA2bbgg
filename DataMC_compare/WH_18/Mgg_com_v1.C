...
//  c1->SetLogy();
  ...
  TFile *fdata1 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_3/SinMu_2018v5_isMu.root");
  TH1F  *h1 = (TH1F*)fdata1->Get("h_dipho_invmass");
  TFile *fdata2 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_3/egamma_2018v4_isEle.root");
  ...
  double w1 = (lumi_18*4.078)/(2.92848e+07);
  TFile *f1 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/TTGJets_v5_isEleMu.root");
  ...
  double w2 = (lumi_18*365.34)/(1.48113e+11);
  TFile *f2 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/TTSL_v5_isEleMu.root");
  ...
  double w3 = (lumi_18*88.29)/(1.03877e+10);
  TFile *f3 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/TTTo2L2Nu_v5_isEleMu.root");
  ...
  double w4 = (lumi_18*5343)/(9.90308e+07);
  TFile *f4 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/DYJetsToLLm50_v3_isEleMu.root");
  ...
  double w10 = (lumi_18*75.8)/(9.104154e+07);
  TFile *f10 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/WW_v3_isEleMu.root");
  ...
  double w11 = (lumi_18*12.14)/(9.14154e+07);
  TFile *f11 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/ZZ_v3_isEleMu.root");
  TH1F *hmc11 = (TH1F*)f11->Get("h_dipho_invmass");
  hmc11->SetBinContent(hmc11->GetNbinsX(), hmc11->GetBinContent(hmc11->GetNbinsX())+hmc11->GetBinContent(hmc11->GetNbinsX()+1));
  hmc11->SetBinContent(1, hmc11->GetBinContent(1)+hmc11->GetBinContent(0));
  hmc11->Scale(w11);

  double w12 = (lumi_18*27.6)/(9.14154e+07);
  TFile *f12 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/WZ_v3_isEleMu.root");
  TH1F *hmc12 = (TH1F*)f12->Get("h_dipho_invmass");
  hmc12->SetBinContent(hmc12->GetNbinsX(), hmc12->GetBinContent(hmc12->GetNbinsX())+hmc12->GetBinContent(hmc12->GetNbinsX()+1));
  hmc12->SetBinContent(1, hmc12->GetBinContent(1)+hmc12->GetBinContent(0));
  hmc12->Scale(w12);

  double w13 = (lumi_18*463.9)/(9.14154e+07);
  TFile *f13 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/WGToLNuG_v3_isEleMu.root");
  ...
  double w14 = (lumi_18*55.48)/(9.14154e+07);
  TFile *f14 = TFile::Open("/home/anirban/data/hh/workspace/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_4/ZGToLLG_v3_isEleMu.root");
...
//  hmc3->Scale(1.2);
  ...
  hmc10->Scale(scaletodata);
//  hmc10->Scale(1.2);
  hmc10->SetFillColor(kGreen-5);
  hmc10->SetFillStyle(1001);
  hmc10->SetLineColor(kBlack);
  ...
  TH1F *hmc10_mod =  (TH1F*)hmc10->Clone();
...
//Divide the bin content with bin width
  ...
  for(int ij=1; ij<=hmc1->GetNbinsX(); ++ij){
	...
	double nmc10 = 1.0*hmc10_mod->GetBinContent(ij)/hmc10_mod->GetBinWidth(ij);
        hmc10_mod->SetBinContent(ij,nmc10);
...
//  legend1->AddEntry(hmc10, "Diboson", "f");
  legend1->AddEntry(hmc3, "TTTo2L2Nu", "f");
  legend1->AddEntry(hmc2, "TTToSemiLepton", "f");
  legend1->Draw();

  TLatex *t2a = new TLatex(0.51,0.9," #bf{CMS} #it{Preliminary}             59.7 fb^{-1} (13 TeV, 2018) ");
  t2a->SetNDC();
  t2a->SetTextFont(42);
