...
//  c1->SetLogy();
  ...
  TFile *fdata1 = TFile::Open("DoubMu_2018v3_isEleMu.root");
  TH1F  *h1 = (TH1F*)fdata1->Get("h_dipho_invmass");
  TFile *fdata2 = TFile::Open("egamma_2018v3_isEleMu.root");
  ...
  TFile *f1 = TFile::Open("TTGJets_v2_isEleMu.root");
  ...
  TFile *f2 = TFile::Open("TTSL_v2_isEleMu.root");
  ...
  TFile *f3 = TFile::Open("TTTo2L2Nu_v2_isEleMu.root");
  ...
  TFile *f4 = TFile::Open("DYJetsToLL_v2_isEleMu.root");
...
//  hs_mod->Add(hmc10_mod,"hist");
  ...
  hs->GetXaxis()->SetRangeUser(xmin,xmax1);
...
//  TH1F *hist_data = (TH1F*)hdata1->Clone();
  ...
  pad2->SetTickx(1);
  pad2->SetTicky(1);
  TLine *line = new TLine(xmin, 1.,xmax1, 1.);
...
//cout<< totalMC->GetNbinsX() << "  " << h1->GetBinContent(1) << endl;
  ...
  band->GetXaxis()->SetRangeUser(xmin,xmax1);
