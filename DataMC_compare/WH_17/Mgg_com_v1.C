...
//  c1->SetLogy();
  ...
  TFile *fdata1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/SinMu_v1_isEleMu.root");
  TH1F  *h1 = (TH1F*)fdata1->Get("h_dipho_invmass");
  TFile *fdata2 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/SingleElectron_v1_isEleMu.root");
  ...
  TFile *f1 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTGJets_v1_isEleMu.root");
  ...
  TFile *f2 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTSL_v1_isEleMu.root");
  ...
  TFile *f3 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTTo2L2Nu_v1_isEleMu.root");
  ...
  TFile *f4 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/DYJetsToLL_v1_isEleMu.root");
  ...
  hmc4->Scale(w4);
/*
  double w5 = (lumi_17*0.01*20)/(923640);
  TFile *f5 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2017/full_reg/full_ver_1/WH_mA20_2017V1_isCom.root");
  TH1F *hsig1 = (TH1F*)f5->Get("h_dipho_invmass");
  hsig1->Scale(w5);

  double w6 = (lumi_17*0.01*20)/(776845);
  TFile *f6 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2017/full_reg/full_ver_1/WH_mA55_2017V1_isCom.root");
