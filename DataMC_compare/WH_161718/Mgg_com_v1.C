...
//  c1->SetLogy();
  ...
  hmc4->Scale(w4);
/*
  double w5 = (lumi_16*0.01*20)/(499129);
  TFile *f5 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2016/full_reg/full_ver_1/WH_mA20V1_isCom.root");
  TH1F *hsig1 = (TH1F*)f5->Get("h_dipho_invmass");
  hsig1->Scale(w5);

  double w6 = (lumi_16*0.01*20)/(499110);
  TFile *f6 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2016/full_reg/full_ver_1/WH_mA55V1_isCom.root");
  TH1F *hsig2 = (TH1F*)f6->Get("h_dipho_invmass");
  hsig2->Scale(w6);
*/
  ...
  hmc10->Scale(w10);
/*
  double w11 = (lumi_16_APV*0.01*20)/(499079);
  TFile *f11 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2016APV/full_reg/full_ver_1/WH_mA20V1_isCom.root");
  TH1F *hsig3 = (TH1F*)f11->Get("h_dipho_invmass");
  hsig3->Scale(w11);

  double w12 = (lumi_16_APV*0.01*20)/(487092);
  TFile *f12 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2016APV/full_reg/full_ver_1/WH_mA55V1_isCom.root");
  TH1F *hsig4 = (TH1F*)f12->Get("h_dipho_invmass");
  hsig4->Scale(w12);
*/
  ...
  TFile *f13 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTGJets_v1_isEleMu.root");
  ...
  TFile *f14 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTSL_v1_isEleMu.root");
  ...
  TFile *f15 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/TTTo2L2Nu_v1_isEleMu.root");
  ...
  TFile *f16 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2017/full_reg/v1/DYJetsToLL_v1_isEleMu.root");
  ...
  hmc16->Scale(w16);
/*
  double w17 = (lumi_17*0.01*20)/(923640);
  TFile *f17 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2017/full_reg/full_ver_1/WH_mA20_2017V1_isCom.root");
  TH1F *hsig5 = (TH1F*)f17->Get("h_dipho_invmass");
  hsig5->Scale(w17);

  double w18 = (lumi_17*0.01*20)/(776845);
  TFile *f18 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2017/full_reg/full_ver_1/WH_mA55_2017V1_isCom.root");
  TH1F *hsig6 = (TH1F*)f18->Get("h_dipho_invmass");
  hsig6->Scale(w18);
*/
  ...
  hmc22->Scale(w22);
/*
  double w23 = (lumi_18*0.01*20)/(993834);
  TFile *f23 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_1/WH_mA20_v7_isCom.root");
  TH1F *hsig7 = (TH1F*)f23->Get("h_dipho_invmass");
  hsig7->Scale(w23);

  double w24 = (lumi_18*0.01*20)/(903853);
  TFile *f24 = TFile::Open("/home/anirban/root_files/CR_studies/new_v1/MVA_modified/WH_2018/full_reg/full_ver_1/WH_mA55_v7_isCom.root");
  TH1F *hsig8 = (TH1F*)f24->Get("h_dipho_invmass");
  hsig8->Scale(w24);
*/
