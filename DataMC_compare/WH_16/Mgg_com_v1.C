...
//  c1->SetLogy();
  ...
  TFile *fdata3 = TFile::Open("/home/anirban/data/hh/workspace/analysis/root_file/WH_2016APV/full_reg/v1/SingleElectron_v1_isEleMu.root");
...
//  legend1->AddEntry(hsig2, "WH mA 55 X 20", "l");
  ...
  TLatex *t2a = new TLatex(0.51,0.9," #bf{CMS} #it{Preliminary}             35.9 fb^{-1} (13 TeV, 2016) ");
  t2a->SetNDC();
  t2a->SetTextFont(42);
