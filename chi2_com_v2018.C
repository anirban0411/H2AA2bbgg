...
//  pad1->SetGridy();
  ...
  TH1F  *h1 = (TH1F*)fdata7->Get("h_chi2");
  h1->Rebin(4);
  ...
  TH1F  *h2 = (TH1F*)fdata8->Get("h_chi2");
  h2->Rebin(4);
  h1->Add(h2);
  ...
  TH1F *hsig1 = (TH1F*)f23->Get("h_chi2");
  hsig1->Scale(w23);
  ...
  TH1F *hsig31 = (TH1F*)f34->Get("h_chi2");
  hsig31->Scale(w34);
...
t2b->DrawLatex(0.9, 0.92, "59.7 fb^{-1} (13 TeV)");
